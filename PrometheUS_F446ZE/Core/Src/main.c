...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Encoder_CS_3_GPIO_Port, Encoder_CS_3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : Encoder_CS_3_Pin */
  GPIO_InitStruct.Pin = Encoder_CS_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Encoder_CS_3_GPIO_Port, &GPIO_InitStruct);
