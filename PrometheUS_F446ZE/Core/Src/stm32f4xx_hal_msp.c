...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  else if(hadc->Instance==ADC3)
  {
    ...
    PA3     ------> ADC3_IN3
    */
    GPIO_InitStruct.Pin = ADC_Current2_Pin|ADC_Current1_Pin|ADC_Current3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  else if(hadc->Instance==ADC3)
  {
    ...
    PA3     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(GPIOF, ADC_Current2_Pin|ADC_Current1_Pin|ADC_Current3_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    PB5     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = GPIO_PIN_4|GPIO_PIN_3|Encoder_Data_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_4|GPIO_PIN_3|Encoder_Data_Pin);
